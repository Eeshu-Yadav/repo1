...
export default function MyProfile() {
  ...
  return (
    <div className="m-5 flex justify-center ">
      <h1 className="mb-14 text-4xl font-semibold text-yellow-50 ">My Profile</h1>
      <div className="flex flex-col justify-center items-center">      <div className="flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
